...
- 映像: MJPEG over Wi-Fi（**標準 = 自作 fixed-cam-streamer**。DroidCam / IP Webcam はフォールバック）→ Unity 内 Texture2D 更新
...
2026-06 から **TableDuo**（テーブル2人非対称VR、`Assets/TableDuo/`、NGO LAN 直結）が同居。FixedCamVr.\* と asmdef 相互参照禁止・シーン排他運用。詳細は CLAUDE.md と docs/table-duo/requirements.md。
